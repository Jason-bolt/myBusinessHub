            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <div class="title">
                        <h2>
                            MyBusinessHub
                            <small>Login Form (Console)</small>
                        </h2>
                        <p style="color: blue; font-size: 14px;">For businesses only</p>
                    </div>
                    <form method="POST" action="../includes/raw_php/console_login_process.php" onsubmit="return validate_form()">
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" name="submit_console_login" type="submit">Login</button>
                        </div>
                    </form>
                </div>
            </div>
